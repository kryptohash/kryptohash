...
bool CMessageHeader::IsValid() const
{
    ...
    // Version number
    if (nVersion != CMessageHeader::CURRENT_VERSION) {
        LogPrintf("CMessageHeader::IsValid() : Incorrect Header Version %u\n", nVersion);
        return false;
    }
...
CInv::CInv(int typeIn, const uint320& hashIn)
{
    type = typeIn;
    hash = hashIn;
}

CInv::CInv(const std::string& strType, const uint320& hashIn)
{
    unsigned int i;
