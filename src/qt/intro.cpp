...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/kryptohash"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Kryptohash"),
     ...
     * override -datadir in the kryptohash.conf file in the default data directory
     * (to be consistent with kryptohashd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
