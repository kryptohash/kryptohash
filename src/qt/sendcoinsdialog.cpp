...
void SendCoinsDialog::processSendCoinsReturn(const WalletModel::SendCoinsReturn &sendCoinsReturn, const QString &msgArg)
{
    ...
    case WalletModel::AmountWithFeeExceedsBalance:
        msgParams.first = tr("The total exceeds your balance when the required %1 transaction fee is included.").arg(msgArg);
        break;
    ...
    case WalletModel::TransactionCommitFailed:
        ...
        msgParams.second = CClientUIInterface::MSG_ERROR;
        break;
    case WalletModel::InvalidAddressGenesis:
        msgParams.first = tr("The recipient address cannot be the Genesis wallet. For donations, please visit kryptohash.org");
        break;
...
void SendCoinsDialog::coinControlChangeEdited(const QString& text)
{
    if (model && model->getAddressTableModel())
    {
        ...
        {
            ui->labelCoinControlChangeLabel->setText(tr("Warning: Invalid Kryptohash address"));
        }
        else // Valid address
        {
            CPubKey pubkey;
